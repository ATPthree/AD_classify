...
def main():
    ...
    parser.add_argument('--file_path', default=os.path.join(r'C:\Users\lxq717machine\Desktop\DementiaBank\Pitt','metadata_allvisits.csv'), type=str,
                        help='filepath for Control and Dementia folders')     
    # ------ Data with pauses for MLU computations ------
    parser.add_argument('--file_path2', default=os.path.join(r'C:\Users\lxq717machine\Desktop\DementiaBank\Pitt','metadata_withPauses.csv'), type=str,
                        help='filepath for Control and Dementia folders')        
